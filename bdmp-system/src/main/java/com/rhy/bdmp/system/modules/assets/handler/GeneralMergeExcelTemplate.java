 ...
 */
@Data
public class GeneralMergeExcelTemplate implements CellWriteHandler {

    private int[] mergeColumnIndex;
    private int mergeRowIndex;

    public GeneralMergeExcelTemplate() {
    }

    public GeneralMergeExcelTemplate(int mergeRowIndex, int[] mergeColumnIndex) {
