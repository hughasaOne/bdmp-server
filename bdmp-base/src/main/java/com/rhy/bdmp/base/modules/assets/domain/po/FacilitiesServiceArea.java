...
public class FacilitiesServiceArea extends FacilitiesExt implements Serializable {
    ...
    @TableField("daily_customer_flow_last")
    private String dailyCustomerFlowLast;
