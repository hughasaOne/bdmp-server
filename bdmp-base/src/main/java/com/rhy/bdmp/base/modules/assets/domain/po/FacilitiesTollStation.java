...
public class FacilitiesTollStation extends FacilitiesExt implements Serializable {
    ...
    @ApiModelProperty(value = "16进制编号")
    @TableField("station_hex_id")
    private String stationHexId;

    @ApiModelProperty(value = "省内编号")
    @TableField("station_province_id")
    private String stationProvinceId;

    @ApiModelProperty(value = "国标编码")
    @TableField("station_country_id")
