package com.rhy.bdmp.collect.modules.camera.domain.po;
 ...
 * @version V1.0
 **/
@ApiModel(value="视频资源(上云)", description="视频资源(上云)信息")
@Data
@AllArgsConstructor
@NoArgsConstructor
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@TableName("t_bdmp_assets_camera_resource_sy")
public class Sy implements Serializable {
    ...
    @ApiModelProperty(value = "位置类型(10:收费站、11:收费站广场、12: :收费亭内、 20:隧道、  30:外场、40:服务区)", example = "1")
