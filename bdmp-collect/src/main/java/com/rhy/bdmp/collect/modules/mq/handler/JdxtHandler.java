...
public class JdxtHandler {
    ...
    @Resource
    private IBaseFacilitiesTollStationLaneService iBaseFacilitiesTollStationLaneService;

    @Async
    public void syncOperatingCompany(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Org org = baseOrgService.getBaseMapper().selectById(entity.getStr("Company_Id"));
                if (null != org){
                ...
                baseOrgService.saveOrUpdate(org);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseOrgService.getBaseMapper().deleteById(entity.getStr("Company_Id"));
            }
        }catch (Exception e){
    ...
    @Async
    public void syncWaySection(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Waysection waysection = baseWaysectionService.getBaseMapper().selectById(entity.getStr("WaySection_Id"));
                if (null != waysection){
                    updateWaysectionData(waysection, entity);
                    waysection.setUpdateTime(DateUtil.date());
                }else {
                    waysection = new Waysection();
                    updateWaysectionData(waysection, entity);
                    waysection.setWaysectionId(entity.getStr("WaySection_Id"));
                    waysection.setCreateTime(DateUtil.date());
                    waysection.setUpdateTime(DateUtil.date());
                    waysection.setWaysectionIdSource("jdxt");
                }
                if (-1 == waysection.getWaysectionName().indexOf("监控中心")){
                    baseWaysectionService.saveOrUpdate(waysection);
                }
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseWaysectionService.getBaseMapper().deleteById(entity.getStr("WaySection_Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncFacilities(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Facilities facilities = baseFacilitiesService.getBaseMapper().selectById(entity.getStr("GeographyInfo_Id"));
                if (null != facilities){
                    updateFacilitiesData(facilities, entity);
                    facilities.setUpdateTime(DateUtil.date());
                }else {
                    facilities = new Facilities();
                    updateFacilitiesData(facilities, entity);
                    facilities.setFacilitiesId(entity.getStr("GeographyInfo_Id"));
                    facilities.setCreateTime(DateUtil.date());
                    facilities.setUpdateTime(DateUtil.date());
                    facilities.setFacilitiesIdSource("jdxt");
                }
                baseFacilitiesService.saveOrUpdate(facilities);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseFacilitiesService.getBaseMapper().deleteById(entity.getStr("GeographyInfo_Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    public void syncDevice(String msg) {
        try{
            ...
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Device device = baseDeviceService.getBaseMapper().selectById(entity.getStr("DeviceRecord_Id"));
                if (null != device){
                ...
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseDeviceService.getBaseMapper().deleteById(entity.getStr("DeviceRecord_Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncVideoResourceTl(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                CameraResourceTl cameraResourceTl = baseCameraResourceTlService.getBaseMapper().selectById(entity.getStr("camera_id"));
                if (null != cameraResourceTl){
                    updateCameraResourceTlData(cameraResourceTl, entity);
                    cameraResourceTl.setUpdateTime(DateUtil.date());
                }else {
                    cameraResourceTl = new CameraResourceTl();
                    updateCameraResourceTlData(cameraResourceTl, entity);
                    cameraResourceTl.setCameraId(entity.getStr("camera_id"));
                    cameraResourceTl.setCreateTime(DateUtil.date());
                    cameraResourceTl.setUpdateTime(DateUtil.date());
                }
                baseCameraResourceTlService.saveOrUpdate(cameraResourceTl);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseCameraResourceTlService.getBaseMapper().deleteById(entity.getStr("camera_id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncVideoResourceYt(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                CameraResourceYt cameraResourceYt = baseCameraResourceYtService.getBaseMapper().selectById(entity.getStr("id"));
                if (null != cameraResourceYt){
                    updateCameraResourceYtData(cameraResourceYt, entity);
                    cameraResourceYt.setUpdateTime(DateUtil.date());
                }else {
                    cameraResourceYt = new CameraResourceYt();
                    updateCameraResourceYtData(cameraResourceYt, entity);
                    cameraResourceYt.setId(entity.getStr("id"));
                    cameraResourceYt.setCreateTime(DateUtil.date());
                    cameraResourceYt.setUpdateTime(DateUtil.date());
                }
                baseCameraResourceYtService.saveOrUpdate(cameraResourceYt);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseCameraResourceYtService.getBaseMapper().deleteById(entity.getStr("id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncDict(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Dict dict = baseDictService.getBaseMapper().selectById(entity.getStr("Id"));
                if (null != dict){
                ...
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseDictService.getBaseMapper().deleteById(entity.getStr("Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncDictItem(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Dict dictItem = baseDictService.getBaseMapper().selectById(entity.getStr("Id"));
                if (null != dictItem){
                    dictItem.setCode(entity.getStr("Id"));
                    dictItem.setName(entity.getStr("Name"));
                    dictItem.setParentId(entity.getStr("Dict_ID"));
                ...
                baseDictService.saveOrUpdate(dictItem);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseDictService.getBaseMapper().deleteById(entity.getStr("Id"));
            }
    ...
    @Async
    public void syncDictBrand(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                DictBrand dictBrand = baseDictBrandService.getBaseMapper().selectById(entity.getStr("BrandInfo_Id"));
                if (null != dictBrand){
                    updateDictBrandData(dictBrand, entity);
                    dictBrand.setUpdateTime(DateUtil.date());
                }else {
                    dictBrand = new DictBrand();
                    updateDictBrandData(dictBrand, entity);
                    dictBrand.setBrandId(entity.getStr("BrandInfo_Id"));
                    dictBrand.setCreateTime(DateUtil.date());
                    dictBrand.setUpdateTime(DateUtil.date());
                    dictBrand.setIdSource("jdxt");
                }
                baseDictBrandService.saveOrUpdate(dictBrand);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseDictBrandService.getBaseMapper().deleteById(entity.getStr("BrandInfo_Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncDictDevice(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                DictDevice dictDevice = baseDictDeviceService.getBaseMapper().selectById(entity.getStr("DeviceDict_Id"));
                if (null != dictDevice){
                    updateDictDeviceData(dictDevice, entity);
                    dictDevice.setUpdateTime(DateUtil.date());
                }else {
                    dictDevice = new DictDevice();
                    updateDictDeviceData(dictDevice, entity);
                    dictDevice.setDeviceDictId(entity.getStr("DeviceDict_Id"));
                    dictDevice.setCreateTime(DateUtil.date());
                    dictDevice.setUpdateTime(DateUtil.date());
                    dictDevice.setIdSource("jdxt");
                }
                baseDictDeviceService.saveOrUpdate(dictDevice);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseDictDeviceService.getBaseMapper().deleteById(entity.getStr("DeviceDict_Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncDictSystem(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                DictSystem dictSystem = baseDictSystemService.getBaseMapper().selectById(entity.getStr("System_Id"));
                if (null != dictSystem){
                    updateDictSystemData(dictSystem, entity);
                    dictSystem.setUpdateTime(DateUtil.date());
                }else {
                    dictSystem = new DictSystem();
                    updateDictSystemData(dictSystem, entity);
                    dictSystem.setSystemId(entity.getStr("System_Id"));
                    dictSystem.setCreateTime(DateUtil.date());
                    dictSystem.setUpdateTime(DateUtil.date());
                    dictSystem.setIdSource("jdxt");
                }
                baseDictSystemService.saveOrUpdate(dictSystem);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseDictSystemService.getBaseMapper().deleteById(entity.getStr("System_Id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncRoute(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                Route route = baseRouteService.getBaseMapper().selectById(entity.getStr("route_id"));
                if (null != route){
                ...
                baseRouteService.saveOrUpdate(route);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseRouteService.getBaseMapper().deleteById(entity.getStr("route_id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncTollStation(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                FacilitiesTollStation tollStation = baseFacilitiesTollStationService.getBaseMapper().selectById(entity.getStr("toll_station_id"));
                if (null != tollStation){
                    updateTollStationData(tollStation, entity);
                }else {
                    tollStation = new FacilitiesTollStation();
                    updateTollStationData(tollStation, entity);
                    tollStation.setTollStationId(entity.getStr("toll_station_id"));
                    tollStation.setIdSource("jdxt");
                }
                baseFacilitiesTollStationService.saveOrUpdate(tollStation);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseFacilitiesTollStationService.getBaseMapper().deleteById(entity.getStr("toll_station_id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncServiceArea(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                FacilitiesServiceArea serviceArea = baseFacilitiesServiceAreaService.getBaseMapper().selectById(entity.getStr("id"));
                if (null != serviceArea){
                    updateServiceAreaData(serviceArea, entity);
                }else {
                    serviceArea = new FacilitiesServiceArea();
                    updateServiceAreaData(serviceArea, entity);
                    serviceArea.setServiceAreaId(entity.getStr("id"));
                    serviceArea.setIdSource("jdxt");
                }
                baseFacilitiesServiceAreaService.saveOrUpdate(serviceArea);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseFacilitiesServiceAreaService.getBaseMapper().deleteById(entity.getStr("id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncBridge(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                FacilitiesBridge bridge = baseFacilitiesBridgeService.getBaseMapper().selectById(entity.getStr("bridge_id"));
                if (null != bridge){
                    updateBridgeData(bridge, entity);
                }else {
                    bridge = new FacilitiesBridge();
                    updateBridgeData(bridge, entity);
                    bridge.setBridgeId(entity.getStr("bridge_id"));
                    bridge.setIdSource("jdxt");
                }
                baseFacilitiesBridgeService.saveOrUpdate(bridge);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseFacilitiesBridgeService.getBaseMapper().deleteById(entity.getStr("bridge_id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncTunnel(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                FacilitiesTunnel tunnel = baseFacilitiesTunnelService.getBaseMapper().selectById(entity.getStr("tunnel_id"));
                if (null != tunnel){
                    updateTunnelData(tunnel, entity);
                }else {
                    tunnel = new FacilitiesTunnel();
                    updateTunnelData(tunnel, entity);
                    tunnel.setTunnelId(entity.getStr("tunnel_id"));
                    tunnel.setIdSource("jdxt");
                }
                baseFacilitiesTunnelService.saveOrUpdate(tunnel);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseFacilitiesTunnelService.getBaseMapper().deleteById(entity.getStr("tunnel_id"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncGantry(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                FacilitiesGantry gantry = baseFacilitiesGantryService.getBaseMapper().selectById(entity.getStr("gantryid"));
                if (null != gantry){
                    updateGantryData(gantry, entity);
                }else {
                    gantry = new FacilitiesGantry();
                    updateGantryData(gantry, entity);
                    gantry.setGantryId(entity.getStr("gantryid"));
                    gantry.setIdSource("jdxt");
                }
                // 更新门架设施ID
                Facilities facilities = baseFacilitiesService.getBaseMapper().selectOne(new QueryWrapper<Facilities>().lambda().eq(Facilities::getFacilitiesIdOld, entity.getStr("gantryid")));
                if (null != facilities){
                    gantry.setFacilitiesId(facilities.getFacilitiesId());
                }
                baseFacilitiesGantryService.saveOrUpdate(gantry);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                baseFacilitiesGantryService.getBaseMapper().deleteById(entity.getStr("gantryid"));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    @Async
    public void syncTollStationLane(String msg) {
        try{
            JSONObject jsonObject = JSONUtil.parseObj(msg);
            if ("c".equals(jsonObject.getJSONObject("payload").getStr("op")) || "u".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("after");
                FacilitiesTollStationLane tollStationLane = iBaseFacilitiesTollStationLaneService.getBaseMapper().selectOne(new QueryWrapper<FacilitiesTollStationLane>().lambda().eq(FacilitiesTollStationLane::getLaneId, entity.getStr("laneid")));
                if (null != tollStationLane){
                    updateTollStationLaneData(tollStationLane, entity);
                    tollStationLane.setUpdateTime(DateUtil.date());
                }else {
                    tollStationLane = new FacilitiesTollStationLane();
                    updateTollStationLaneData(tollStationLane, entity);
                    tollStationLane.setCreateTime(DateUtil.date());
                    tollStationLane.setUpdateTime(DateUtil.date());
                    tollStationLane.setIdSource("jdxt");
                }
                iBaseFacilitiesTollStationLaneService.saveOrUpdate(tollStationLane);
            }  else if ("d".equals(jsonObject.getJSONObject("payload").getStr("op"))) {
                JSONObject entity = jsonObject.getJSONObject("payload").getJSONObject("before");
                iBaseFacilitiesTollStationLaneService.getBaseMapper().delete(new QueryWrapper<FacilitiesTollStationLane>().lambda().eq(FacilitiesTollStationLane::getLaneId, entity.getStr("laneid")));
            }
        }catch (Exception e){
            log.error(e.getMessage());
        }
    ...
    private Org updateOrgData(Org org, JSONObject entity){
    ...
    private Waysection updateWaysectionData(Waysection waysection, JSONObject entity){
    ...
    private Facilities updateFacilitiesData(Facilities facilities, JSONObject entity){
    ...
    private Device updateDeviceData(Device device, JSONObject entity){
    ...
    private CameraResourceTl updateCameraResourceTlData(CameraResourceTl cameraResourceTl, JSONObject entity){
    ...
    private CameraResourceYt updateCameraResourceYtData(CameraResourceYt cameraResourceYt, JSONObject entity){
    ...
    private DictBrand updateDictBrandData(DictBrand dictBrand, JSONObject entity){
    ...
    private DictDevice updateDictDeviceData(DictDevice dictDevice, JSONObject entity){
    ...
    private DictSystem updateDictSystemData(DictSystem dictSystem, JSONObject entity){
    ...
    private Route updateRouteData(Route route, JSONObject entity) {
    ...
    private FacilitiesTollStation updateTollStationData(FacilitiesTollStation tollStation, JSONObject entity){
    ...
    private FacilitiesServiceArea updateServiceAreaData(FacilitiesServiceArea serviceArea, JSONObject entity){
    ...
    private FacilitiesBridge updateBridgeData(FacilitiesBridge bridge, JSONObject entity){
    ...
    private FacilitiesTunnel updateTunnelData(FacilitiesTunnel tunnel, JSONObject entity){
    ...
    private FacilitiesGantry updateGantryData(FacilitiesGantry gantry, JSONObject entity){
    ...
    private FacilitiesTollStationLane updateTollStationLaneData(FacilitiesTollStationLane tollStationLane, JSONObject entity){
